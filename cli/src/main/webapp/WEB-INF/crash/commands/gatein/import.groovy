...
""")
  @Command
  public Object main(@Required @FileOption String file, @FilterOption List<String> filters, @ImportModeOption String importMode, @Argument String path) throws ScriptException
  {
    assertConnected()
    ...
    if (filters != null) attributes["filter"] = filters;
